...
import { getUserName, setUserName } from '../modules/user';
            ...
            <TableBody>
              {boardList.map((data, i) => (
                <TableRow
                  ...
                  key={i}
                  onClick={() => onClickItem(data.num)}
                >
                  <TableCell>{data.num}</TableCell>
                  <TableCell>
                    {data.imageFile && (
                      <img
                        src={config.apiServer + '/uploads/' + data.imageFile}
                        alt=" "
                        width="50px"
                        height="50px"
                      />
          ...
          <Box display="flex">
            {userName !== '' && (
              <Button
                ...
                onClick={() => routeChange('/board_write')}
              >
                글쓰기
              </Button>
            )}
